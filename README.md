...
```
pip install dist/nomad-dls_measurements-0.1.0
```
...
### License
Distributed under the terms of the `MIT`_ license, "nomad-dls_measurements" is free and open source software

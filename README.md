...
```sh
git clone https://github.com/lankovas/dls_measurements.git
cd dls_measurements
...
```sh
pip install dist/dls_measurements-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| stepanka.lankova@gmail.com | [stepanka.lankova@gmail.com](mailto:stepanka.lankova@gmail.com)
